...
define('USERNAME', 't7325173827-api');
define('PASSWORD', 'gjeyJU1p');
define('GATEWAY_URL', 'https://3dsec.sberbank.ru/payment/rest/register.do');
define('RETURN_URL', 'https://e-jschool.ru/');
